...
Orchestrator: liste, viewability, navigation, refresh/load-more ve state yonetimi.

```tsx
import React, { useCallback, useRef, useState } from 'react';
import { View, Text, Pressable, RefreshControl, ActivityIndicator, FlatList } from 'react-native';
