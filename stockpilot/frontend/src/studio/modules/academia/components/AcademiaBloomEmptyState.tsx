...
export const AcademiaBloomEmptyState = memo(function AcademiaBloomEmptyState({ onUploadClick }: Props) {
    return (
                ...
                <section className="relative flex min-h-0 w-full flex-1 p-4 lg:w-[39%] lg:flex-none lg:p-6 xl:w-[35%]">
                    <div className="relative z-10 flex h-full w-full flex-col px-6 py-5 lg:px-10 lg:py-8">
                        <div className="flex flex-1 flex-col items-center justify-center text-center">
                            <div className="flex max-w-xl flex-col items-center gap-10 lg:gap-12">
                                <h1 className="font-bloom-display max-w-4xl text-5xl font-medium leading-[0.92] tracking-[-0.05em] text-white md:text-6xl xl:text-7xl">
                                ...
                                <button
                                    ...
                                    className="liquid-glass-strong bloom-upload-cta inline-flex items-center gap-3 rounded-full px-5 py-3 font-bloom-display text-sm font-medium text-white"
                                >
                                ...
                                <div className="flex w-full flex-col items-center gap-4 text-center">
                                    <span className="font-bloom-display text-xs uppercase tracking-[0.38em] text-white/50 lg:text-[13px]">
                                        INTELLIGENT STUDY FLOW
                                    </span>
                                    <p className="font-bloom-display text-xl font-medium tracking-[-0.03em] text-white/90 lg:text-[1.4rem] lg:leading-[1.55]">
                                    ...
                                    <div className="flex items-center gap-3 text-white/60">
                                        ...
                                        <span className="font-bloom-display text-xs uppercase tracking-[0.34em] lg:text-[13px]">
                                            S+ACADEMIA
                                        </span>
                                        <span className="h-px w-10 bg-white/20" />
                                    </div>
