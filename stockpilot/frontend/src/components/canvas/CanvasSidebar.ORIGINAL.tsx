...
export function CanvasSidebar({
    ...
    return (
        <>
        <aside className="flex h-[calc(100vh-130px)] flex-col overflow-hidden rounded-[12px] border border-slate-200/70 bg-white/80 p-6 shadow-[0_32px_90px_-46px_rgba(11,14,20,0.34)] backdrop-blur-xl">
