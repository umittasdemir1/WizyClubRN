...
export default function UploadComposerScreen() {
    ...
    const persistComposerDraft = (overrides: Partial<UploadComposerDraft> = {}) => {
        ...
        useUploadComposerStore.getState().setDraft({
            ...
            locationName: previousDraft?.locationName,
            locationAddress: previousDraft?.locationAddress,
            locationLatitude: previousDraft?.locationLatitude,
            locationLongitude: previousDraft?.locationLongitude,
