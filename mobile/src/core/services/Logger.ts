...
export enum LogCode {
    ...
    VIDEO_UPLOAD_PAYLOAD_USED = 2037,
    VIDEO_UPLOAD_POLL_RESOLVED = 2038,
    VIDEO_UPLOAD_POLL_MISSED = 2039,
    VIDEO_UPLOAD_REFRESH_SKIPPED = 2040,
    VIDEO_UPLOAD_REFRESH_TRIGGERED = 2041,
    VIDEO_UPLOAD_FLOW_SUMMARY = 2042,
