...
export interface PoolFeedDoubleTapLikeRef {
    animateLike: () => void;
}

const DOUBLE_TAP_DELAY = 350;

const PoolFeedDoubleTapLikeComponent = forwardRef<PoolFeedDoubleTapLikeRef, DoubleTapLikeProps>(
...
PoolFeedDoubleTapLikeComponent.displayName = 'PoolFeedDoubleTapLike';

export const PoolFeedDoubleTapLike = PoolFeedDoubleTapLikeComponent;
