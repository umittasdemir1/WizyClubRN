...
import { PoolFeedSpritePreview } from './PoolFeedSpritePreview';
...
interface PoolFeedVideoSeekBarProps {
    currentTime: SharedValue<number>;
    duration: SharedValue<number>;
    isScrolling?: SharedValue<boolean>;
    onSeek: PoolFeedVideoPlayerPoolRef['seekTo'];
    isActive?: boolean;
    spriteUrl?: string;
    bottomOffset?: number;
}

export function PoolFeedVideoSeekBar({
    currentTime,
    duration,
    isScrolling,
    onSeek,
