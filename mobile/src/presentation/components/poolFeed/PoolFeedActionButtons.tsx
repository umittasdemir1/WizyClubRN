...
export interface PoolFeedActionButtonsRef {
    animateLike: () => void;
}
...
export const PoolFeedActionButtons = memo(forwardRef<PoolFeedActionButtonsRef, ActionButtonsProps>(function PoolFeedActionButtons({
    state,
    handlers,
}, ref) {
    const {
