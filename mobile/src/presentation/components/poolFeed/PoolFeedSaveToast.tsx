/**
 * PoolFeedSaveToast - Animated notification for save actions
 *
 * Displays a toast at the top of the screen when a user saves or unsaves a video.
 * Extracted from PoolFeedOverlays for better modularity.
 *
 * @module presentation/components/feed/PoolFeedSaveToast
 */
...
import { FEED_COLORS } from './hooks/usePoolFeedConfig';

interface PoolFeedSaveToastProps {
...
export const PoolFeedSaveToast: React.FC<PoolFeedSaveToastProps> = ({
    message,
    active,
    opacity,
    translateY,
