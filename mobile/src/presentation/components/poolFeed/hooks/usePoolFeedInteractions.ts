/**
 * usePoolFeedInteractions - Feed Gesture & Interaction Hook
 *
 ...
 *
 * @module presentation/components/feed/hooks/usePoolFeedInteractions
 */
 ...
 */
export function usePoolFeedInteractions(options: UseFeedInteractionsOptions): UseFeedInteractionsReturn {
    const {
        videosRef,
        toggleLike,
        togglePause,
