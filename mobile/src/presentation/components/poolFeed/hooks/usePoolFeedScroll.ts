/**
 * usePoolFeedScroll - Feed Scroll Management Hook
 *
 ...
 *
 * @module presentation/components/feed/hooks/usePoolFeedScroll
 */
 ...
 */
export function usePoolFeedScroll(options: UseFeedScrollOptions): UseFeedScrollReturn {
    const {
        videosRef,
        setActiveVideo,
        setCleanScreen,
