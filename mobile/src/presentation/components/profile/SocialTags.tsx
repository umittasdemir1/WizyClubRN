...
export const SocialTags: React.FC<SocialTagsProps> = ({
    ...
    const panelLinks = [
        ...
        },
        {
            ...
            source: require('../../../../assets/SocialMediaIcons/Instagram/Instagram.png'),
            size: 25,
        ...
        },
        {
            ...
            url: user?.tiktokUrl,
            source: require('../../../../assets/SocialMediaIcons/TikTok/TikTok.png'),
            size: 25,
        ...
        },
        {
            ...
            platform: 'x' as const,
            url: user?.xUrl,
            source: require('../../../../assets/SocialMediaIcons/X/X.png'),
            size: 23,
        ...
        },
        {
            ...
            url: user?.youtubeUrl,
            source: require('../../../../assets/SocialMediaIcons/Youtube/Youtube.png'),
            size: 35,
