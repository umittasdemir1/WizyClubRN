...
const CARD_WIDTH = SCREEN_WIDTH * 0.95; // KARTLARI ÇOK BÜYÜTTÜK (%90)
...
// Kart %90 olduğu için kalan boşluk %10'dir. Bunun yarısı %5 sağa, %5 sola düşer.

const SIDE_OFFSET = (SCREEN_WIDTH - CARD_WIDTH) / 2.5;
