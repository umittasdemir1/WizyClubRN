...
// --- AYARLAR ---
const CARD_WIDTH = SCREEN_WIDTH * 0.85; // %85 Genişlik
const ASPECT_RATIO = 16 / 9;
const CARD_HEIGHT = CARD_WIDTH / ASPECT_RATIO;
const GAP = 15; // Kartlar arası boşluk

// --- DÜZELTİLEN KRİTİK HİZALAMA ---
// HATA BURADAYDI: Eskiden / 4 yapıyordun.
// DOĞRUSU: (Ekran - Kart) / 2.
// Bu formül "Kalan boşluğun yarısını sola ver" demektir. Tam ortalar.
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Matematiksel olarak tam ortaya iten görünmez kutu */}
